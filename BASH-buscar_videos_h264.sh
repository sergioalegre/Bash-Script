...
#Este script busca en el path dado como parametro de manera recursiva, archivos h264
...
#find -type f \( -name "*mp4" -o -name "*mkv" -o -name "*.mpg" -o -name "*.mpeg" -o -name "*.avi" -o -name "*.flv" -o -name "*.AVI" -o -name "*.divx" -o -name "*.m4v" -o -name "*.ogm" \)
...
function path(){
    ...
    echo -e "\n${yellowColour} Videos con h264 en $path_escanear\n${lista_corregir[@]}${endColour}"
}
